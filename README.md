...
The packages in the `ur_description` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy ur_description --override-release-repository-push-url git@github.com:revyos-ros/ur_description-release.git --edit` on `Mon, 23 Jun 2025 07:43:47 -0000`
...
- release repository: https://github.com/revyos-ros/ur_description-release.git
...
## ur_description (jazzy) - 4.0.0-3

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy ur_description --override-release-repository-push-url git@github.com:revyos-ros/ur_description-release.git` on `Mon, 23 Jun 2025 06:20:40 -0000`
...
## ur_description (jazzy) - 4.0.0-2

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy ur_description --override-release-repository-push-url git@github.com:revyos-ros/ur_description-release.git` on `Fri, 13 Jun 2025 06:10:57 -0000`
...
## ur_description (jazzy) - 4.0.0-1

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy ur_description --override-release-repository-push-url git@github.com:revyos-ros/ur_description-release.git` on `Fri, 13 Jun 2025 03:56:18 -0000`
...
The packages in the `ur_description` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy ur_description --override-release-repository-push-url git@github.com:revyos-ros/ur_description-release.git` on `Thu, 06 Mar 2025 09:12:43 -0000`
...
The packages in the `ur_description` repository were released into the `humble` distro by running `/root/venv/bin/bloom-release -r humble ur_description --override-release-repository-push-url git@github.com:revyos-ros/ur_description-release.git` on `Tue, 04 Mar 2025 06:22:37 -0000`
...
The packages in the `ur_description` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy ur_description --override-release-repository-push-url git@github.com:revyos-ros/ur_description-release.git` on `Thu, 19 Dec 2024 08:15:20 -0000`
...
The packages in the `ur_description` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble ur_description --override-release-repository-push-url git@github.com:revyos-ros/ur_description-release.git` on `Thu, 12 Dec 2024 06:53:36 -0000`
...
The packages in the `ur_description` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy ur_description --override-release-repository-push-url git@github.com:revyos-ros/ur_description-release.git` on `Fri, 27 Sep 2024 01:41:15 -0000`
...
The packages in the `ur_description` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble ur_description --override-release-repository-push-url git@github.com:revyos-ros/ur_description-release.git` on `Mon, 23 Sep 2024 03:39:52 -0000`
